...
const DETAILED = {
  ...
  3: [{id:'learn-new-language',name:'Naucz się nowego języka',desc:'Zacznij od zapisania się na zajęcia językowe lub korzystania z aplikacji do nauki języków. Ćwicz codziennie, aby poprawić swoje umiejętności językowe.',barriers:['Brak motywacji','Trudność w zapamiętywaniu','Koszt kursów']},{id:'play-instrument',name:'Graj na instrumencie muzycznym',desc:'Wybierz instrument, który Cię interesuje i weź lekcje dla początkujących. Poświęć czas każdego tygodnia na praktykę.',barriers:['Koszt instrumentu','Brak nauczyciela','Obawa przed porażką']},{id:'join-theater-group',name:'Dołącz do lokalnego teatru',desc:'Znajdź lokalne grupy teatralne i weź udział w ich działaniach. Weź udział w przedstawieniach i rozważ dołączenie jako wolontariusz lub aktor.',barriers:['Trema','Brak grup w okolicy','Brak doświadczenia']},{id:'attend-lectures',name:'Uczęszczaj na wykłady',desc:'Szukaj interesujących wykładów w swojej społeczności lub online. Wyrób sobie nawyk uczęszczania na co najmniej jeden wykład w miesiącu.',barriers:['Brak czasu','Nie wiem gdzie szukać','Brak ciekawych tematów']},{id:'volunteer-regularly',name:'Wolontariat regularnie',desc:'Zidentyfikuj sprawy, które Cię pasjonują i zarejestruj się, aby skorzystać z możliwości wolontariatu. Angażuj się w te działania co tydzień lub co miesiąc.',barriers:['Brak czasu','Nie wiem od czego zacząć','Obawa przed zobowiązaniem']},{id:'practice-mindfulness-daily',name:'Praktykuj uważność',desc:'Włącz praktyki uważności do swojej codziennej rutyny. Korzystaj z aplikacji lub uczęszczaj na zajęcia, aby prowadzić swoje sesje medytacyjne.',barriers:['Trudność ze skupieniem','Natłok myśli','Brak czasu']},{id:'explore-new-hobby',name:'Zaangażuj się w nowe hobby',desc:'Spróbuj znaleźć nowe hobby, takie jak malowanie, gotowanie lub ogrodnictwo. Poświęć czas na regularne odkrywanie tych zainteresowań.',barriers:['Nie wiem co wybrać','Koszt materiałów','Brak miejsca']},{id:'join-social-clubs',name:'Dołącz do klubów społecznościowych',desc:'Zostań członkiem lokalnych klubów lub grup społecznościowych, które są zgodne z Twoimi zainteresowaniami. Bierz udział w spotkaniach i bierz w nich aktywny udział.',barriers:['Nieśmiałość','Brak klubów w okolicy','Brak czasu']},{id:'solve-puzzles-games',name:'Rozwiązuj zagadki i gry',desc:'Poświęć czas na gry ćwiczące mózg, takie jak łamigłówki, krzyżówki lub Sudoku, aby zachować ostrość umysłu.',barriers:['Nie lubię łamigłówek','Wydaje się dziecinne','Trudność w znalezieniu poziomu']},{id:'read-widely',name:'Czytaj szeroko',desc:'Wybieraj książki na różne tematy i spraw, aby czytanie stało się codziennym nawykiem. Omów swoje czytania z innymi, aby pogłębić swoje zrozumienie.',barriers:['Trudność ze skupieniem','Problemy ze wzrokiem','Brak ciekawych książek']},{id:'attend-community-events',name:'Bierz udział w wydarzeniach społecznościowych',desc:'Bierz udział w lokalnych wydarzeniach, aby pozostać aktywnym społecznie. Może to obejmować festiwale, targi lub prace społeczne.',barriers:['Nieśmiałość','Brak informacji','Brak towarzystwa']},{id:'take-skill-workshops',name:'Weź udział w warsztatach zręcznościowych',desc:'Zapisz się na warsztaty lub zajęcia, które uczą nowych umiejętności. Może to być wszystko, od lekcji gotowania po kursy technologii.',barriers:['Koszt warsztatów','Brak czasu','Obawa przed nowością']},{id:'travel-and-explore',name:'Podróżuj i odkrywaj',desc:'Planuj wycieczki do nowych miejsc, aby zdobyć świeże doświadczenia i perspektywy. Podróżuj lokalnie lub międzynarodowo zgodnie z własnym komfortem.',barriers:['Koszt podróży','Obawa przed nieznanym','Brak towarzystwa']},{id:'discuss-new-ideas',name:'Omawiaj nowe pomysły',desc:'Regularnie dyskutuj z przyjaciółmi lub rodziną na temat nowych pomysłów i tematów. Można to zrobić przy posiłkach lub przypadkowych spotkaniach.',barriers:['Brak osób do dyskusji','Unikanie kontrowersji','Brak pewności siebie']},{id:'creative-activities-engage',name:'Zaangażuj się w kreatywne zajęcia',desc:'Poświęć czas na kreatywne zajęcia, takie jak malowanie, pisanie lub rękodzieło. Zajęcia te mogą być zarówno relaksujące, jak i stymulujące.',barriers:['Brak talentu','Brak materiałów','Perfekcjonizm']}],
  4: [{id:'increase-dairy-intake',name:'Zwiększ spożycie nabiału',desc:'Włącz do swojej diety więcej mleka, sera i jogurtu, aby zwiększyć spożycie wapnia.',barriers:['Nietolerancja laktozy','Nie lubię nabiału','Koszt produktów']},{id:'add-leafy-greens',name:'Dodaj zielone warzywa liściaste',desc:'Włącz do posiłków zielone warzywa liściaste, takie jak szpinak, jarmuż i brokuły, aby zwiększyć poziom wapnia.',barriers:['Nie lubię zielonych warzyw','Sezonowość','Brak pomysłów na przygotowanie']},{id:'eat-fortified-foods',name:'Spożywaj wzbogaconą żywność',desc:'Jedz wzbogacone płatki zbożowe i mleko, aby zapewnić sobie wystarczającą ilość wapnia i witaminy D.',barriers:['Trudność w znalezieniu','Wyższa cena','Nie wiem co wybierać']},{id:'get-sunlight-exposure',name:'Uzyskaj ekspozycję na światło słoneczne',desc:'Spędzaj co najmniej 15 minut dziennie na zewnątrz, aby wchłonąć witaminę D ze światła słonecznego.',barriers:['Praca w biurze','Zima/brak słońca','Obawa przed słońcem']},{id:'weight-bearing-exercise',name:'Angażuj się w ćwiczenia z obciążeniem',desc:'Regularnie spaceruj, biegaj lub podnoś lekkie ciężary, aby wzmocnić kości.',barriers:['Brak czasu','Obawa przed kontuzją','Brak sprzętu']},{id:'eat-fatty-fish',name:'Jedz tłuste ryby',desc:'Włącz łososia, makrelę i inne tłuste ryby do swojej diety, aby uzyskać witaminę D.',barriers:['Nie lubię ryb','Wysoka cena','Trudność w przygotowaniu']},{id:'discuss-supplements',name:'Porozmawiaj o suplementach z lekarzem',desc:'Skonsultuj się z lekarzem w sprawie zapotrzebowania na suplementy wapnia i witaminy D.',barriers:['Brak czasu na wizytę','Obawa przed lekarzem','Koszt konsultacji']},{id:'bone-density-checks',name:'Zaplanuj wizyty kontrolne gęstości kości',desc:'Wykonuj regularne testy gęstości kości, aby monitorować stan kości.',barriers:['Brak dostępu do densytometru','Koszt badania','Nie wiem gdzie zrobić']},{id:'safe-sun-exposure',name:'Ćwicz bezpieczną ekspozycję na słońce',desc:'Zrównoważ ekspozycję na słońce z ochroną skóry, aby uniknąć ryzyka, jednocześnie czerpiąc korzyści z witaminy D.',barriers:['Trudność w znalezieniu równowagi','Brak wiedzy o SPF','Zapominanie o kremie']},{id:'vitamin-d-foods',name:'Włącz pokarmy bogate w witaminę D',desc:'Jedz pokarmy takie jak jajka, grzyby i wzbogacony sok pomarańczowy, aby zwiększyć poziom witaminy D.',barriers:['Ograniczenia dietetyczne','Brak wiedzy o źródłach','Koszt produktów']},{id:'maintain-hydration-bones',name:'Utrzymuj nawodnienie',desc:'Pij dużo wody, aby wspierać ogólne zdrowie kości i funkcje organizmu.',barriers:['Zapominanie o piciu','Nie lubię wody','Częste wizyty w toalecie']},{id:'track-calcium-intake',name:'Monitoruj spożycie wapnia',desc:'Śledź dzienne spożycie wapnia, aby upewnić się, że spełniasz zalecane poziomy.',barriers:['Trudność w śledzeniu','Brak wiedzy o zawartości wapnia','Czasochłonność']},{id:'balanced-diet-bones',name:'Utrzymuj zbilansowaną dietę',desc:'Upewnij się, że Twoja dieta zawiera różnorodne składniki odżywcze, które wspierają zdrowie kości.',barriers:['Brak wiedzy żywieniowej','Trudność w planowaniu','Koszt różnorodnych produktów']},{id:'limit-alcohol-bones',name:'Unikaj nadmiernego spożycia alkoholu',desc:'Ogranicz spożycie alkoholu, ponieważ może on negatywnie wpłynąć na gęstość kości.',barriers:['Presja społeczna','Nawyk','Trudność w odmawianiu']},{id:'quit-smoking-bones',name:'Rzuć palenie',desc:'Jeśli palisz, szukaj pomocy, aby rzucić palenie, ponieważ palenie może osłabić twoje kości.',barriers:['Silne uzależnienie','Brak wsparcia','Lęk przed przytyciem']}],
