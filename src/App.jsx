...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-50">
      {/* PEMF Banner */}
      <a
        href="https://app.justap.io/card/aplikacja/coach"
        target="_blank"
        rel="noopener noreferrer"
        className="block bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-700 text-white 
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-base sm:text-lg leading-tight">
                Wzmocnij swój zdrowy styl życia z technologią <span className="underline decoration-2 decoration-white/40">PEMF</span>
              </p>
              <p className="text-violet-200 text-sm mt-0.5 hidden sm:block">
                Terapia polem elektromagnetycznym — odzyskaj energię, zredukuj stres, przyspiesz regenerację →
              </p>
            </div>
          </div>
          <span className="flex-shrink-0 ml-4 px-4 py-2 bg-white text-purple-700 font-bold text-sm rounded-full 
                           group-hover:bg-violet-100 group-hover:scale-105 transition-all duration-300 shadow-lg whitespace-nowrap">
            Sprawdź →
          </span>
        </div>
      </a>
