    ...
    <div className="min-h-screen flex flex-col bg-stone-50">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 -mt-6 pb-12 w-full">
        ...
        <div className="bg-white rounded-2xl shadow-lg border-l-4 border-green-500 p-6 mb-6 animate-slide-up">
          ...
          <div className="flex items-center gap-2 text-sm text-stone-500"><span className="inline-flex items-center gap-1 bg-stone-100 rounded-full px-3 py-1 font-semibold text-green-700">{doneCount}/{total} czynników wdrożonych</span></div>
        </div>
